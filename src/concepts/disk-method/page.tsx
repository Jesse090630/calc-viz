...
import { DISK_METHOD_CHAIN } from './chain';
import { DiskScene } from './DiskScene';

const STORE = createChainStore(createReducedMotionChain(DISK_METHOD_CHAIN));

export default function Page() {
  return (
    <LessonPage
      chain={DISK_METHOD_CHAIN}
      useChain={STORE}
      renderScene={DiskScene}
    />
  );
}
