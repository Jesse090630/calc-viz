...
import { LIMITS_CHAIN } from './chain';
import { LimitsScene } from './LimitsScene';

const STORE = createChainStore(createReducedMotionChain(LIMITS_CHAIN));
