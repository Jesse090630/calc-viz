...
import { SHELL_METHOD_CHAIN } from './chain';
import { ShellScene } from './ShellScene';

const STORE = createChainStore(createReducedMotionChain(SHELL_METHOD_CHAIN));

export default function Page() {
  return (
    <LessonPage
      chain={SHELL_METHOD_CHAIN}
      useChain={STORE}
      renderScene={ShellScene}
    />
  );
}
