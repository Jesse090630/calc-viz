...
import { UNIT_CIRCLE_CHAIN } from './chain';
import { UnitCircleScene } from './UnitCircleScene';

const STORE = createChainStore(createReducedMotionChain(UNIT_CIRCLE_CHAIN));

export default function Page() {
  return (
    <LessonPage
      chain={UNIT_CIRCLE_CHAIN}
      useChain={STORE}
      renderScene={UnitCircleScene}
      className="unit-circle-page"
    />
  );
}
