...
for (const [name, width, height] of [['desktop', 1440, 1200], ['mobile', 430, 1400]]) {
  ...
  if (cards !== 12) errors.push(`[${name}] expected 12 cards, got ${cards}`);
  ...
  // 概念名都在
  for (const want of ['One-Sided Limits', 'Increasing and Decreasing Intervals', 'Nondecreasing Functions', 'Nonincreasing Functions', 'Definition of a Function', 'Domain of a Function', 'Increasing Functions', 'Even and Odd Functions', 'Periodic Functions', 'Average Rate of Change', 'The Floor Function', 'The Ceiling Function']) {
...
const NAMES = {
  ...
  intervals: 'Increasing and Decreasing Intervals', 'one-sided': 'One-Sided Limits',
